...
export function CatalogHeader({ className }: CatalogHeaderProps) {
  return (
    <header className={cn("px-6 md:px-8 mb-8 md:mb-12", className)}>
      <div className="max-w-screen-2xl mx-auto">
        ...
        <p style={{ maxWidth: '36rem', wordBreak: 'keep-all', overflowWrap: 'normal', whiteSpace: 'normal' }} className="text-base md:text-lg text-on-surface-variant leading-relaxed">
