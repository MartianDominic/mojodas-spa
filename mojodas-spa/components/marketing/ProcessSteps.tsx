  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-surface">
      <div className="container mx-auto px-6">
        <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl text-center mb-12 md:mb-16 leading-tight tracking-tight max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:p-8 lg:p-12 relative">
          {steps.map((step) => (
            <div key={step.number} className="group">
              <div className="text-5xl md:text-6xl font-headline text-primary/10 leading-none mb-[-24px] select-none">
                {step.number}
              </div>
